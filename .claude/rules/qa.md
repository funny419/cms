...
> **최종 업데이트:** 2026-04-16 (BUG-7 이후 신규 BUG 없음)
...
| 반응형 레이아웃 (Nav, Admin 테이블) | responsive.spec.js 전체 TC |
| 접근성(a11y) 변경 (aria-label 등) | TC-U043, TC-U048, TC-U049 (access-control.spec.js) |
| Admin 회원 관리 (admin.py, AdminUsers) | AdminUsers 페이지네이션 관련 TC |
